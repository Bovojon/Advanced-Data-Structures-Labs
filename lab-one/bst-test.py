...
Notes:
- The test works on Jupyter but not on a local terminal
- There are 7 expected fail cases
- There are a combination of assertTrue() and assertEqual() tests
"""
...
#################################### Test positional methods
    ...
    def test_find_position_exists(self):
        self.assertEqual(self.tree.find_position(32), self.tree.root())
